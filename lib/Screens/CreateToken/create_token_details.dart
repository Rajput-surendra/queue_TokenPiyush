...
class CreateTokenDetails extends StatefulWidget {
   CreateTokenDetails({Key? key,this.tokenTd}) : super(key: key);
  String? tokenTd;
  @override
  State<CreateTokenDetails> createState() => _CreateTokenDetailsState();
}

class _CreateTokenDetailsState extends State<CreateTokenDetails> {
  @override
  void initState() {
                                ...
                                children: [
                                  ...
                                  getTokenDetailsModel?.data?[i].status == "0"?InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: const Center(child:Text("Panding",style: TextStyle(color: AppColors.fntClr,fontWeight: FontWeight.w500))
                                      ),
                                    ),
